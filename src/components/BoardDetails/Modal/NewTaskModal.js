...
import { toggleNewTaskModal } from "../../../redux/NewTaskModal/newTaskModalActions";
...
const NewTaskModal = (props) => {
  ...
  return (
    <>
      <button onClick={openModal}> buka</button>
      <Modal
        isOpen={props.isOpen}
        style={{
          content: {
      ...
      >
        <Row justify="space-between">
          ...
          <Col flex="5%">
            ...
            >
              <path
                d="M0 0H24V5.33333H0V0ZM1.33333 24V6.66667H22.6667V24H1.33333ZM14.6667 14.6667V10.6667H9.33333V14.6667H5.33333L12 21.3333L18.6667 14.6667H14.6667Z"
                fill="#363636"
              />
            </svg>
          </Col>
        ...
        <Row margin="0 0 24px">
          <Col flex="60%">
            ...
            <Row justify="flex-end">
              <Col>
                <StyledButton onClick={props.onClose} secondary>
                  Cancel
                </StyledButton>
              </Col>
              <Col>
...
// const mstp = (state) => {
//   return {
//     newTaskModalIsOpen: state.taskModal.newTaskModalIsOpen,
//   };
// };

// const mdtp = (dispatch) => {
//   return {
//     toggleNewTaskModal: () => dispatch(toggleNewTaskModal()),
//   };
// };
